            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-2 mr-5">Franchise Employee List</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{url('franchises-emp/create')}}" class="btn btn-primary font-weight-bold btn-sm">Add Employee</a>
                    <!--end::Actions-->
                </div>
                <!--end::Toolbar-->
            </div>
                ...
                <div class="card card-custom">
                    <div class="card-body">
                        <table class="table table-bordered table-checkable" id="kt_datatable">
                            ...
                            @foreach($emp as $item)
                                <?php
                                    $franchiseCompanyName = \Illuminate\Support\Facades\DB::table('users')->where('id',$item->fr_id)->first();
                                    ?>
                                <tr>
                                    <td> {{$item->code ? $item->code : '-'}}</td>
                                    <td> {{$item->name}}</td>
                                    <td> {{$item->role == 'Editor' ? "Editor" : "Telecaller"}}</td>
                                    <td> {{isset($franchiseCompanyName->company_name)?$franchiseCompanyName->company_name:''}}</td>
