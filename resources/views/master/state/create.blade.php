        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('state.index')}}" class="btn  font-weight-bolder btn-sm">
                ...
                <div class="col-lg-8">
                    <div class="card card-custom gutter-b example example-compact">
                        <form class="form" id="kt_form"
                              action="{{ isset($state)?route('state.update',$state->state_id):route('state.store') }}"
                              method="POST">
                            @csrf
                            @isset($state)
                                @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label ">State Name<span class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input
                                            class="form-control {{ $errors->has('state_name') ? 'is-invalid' : '' }}"
                                            type="text" name="state_name" id="state_name"
                                            autocomplete="off"
                                            placeholder="Enter state Name"
                                            value="{{ old('state_name')?old('state_name'):(isset($state)?$state->state_name:'')}}"/>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label ">State Code<span class="text-danger">*</span></label>
                                    <div class="col-lg-6">
                                        <input
                                            class="form-control {{ $errors->has('state_code') ? 'is-invalid' : '' }}"
                                            type="text" name="state_code" id="state_code"
                                            autocomplete="off"
                                            placeholder="Enter state Code"
                                            value="{{ old('state_code')?old('state_code'):(isset($state)?$state->state_code:'')}}"/>
