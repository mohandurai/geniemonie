            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        <!--begin::Page Title-->
                        <h5 class="text-dark font-weight-bold my-2 mr-5">Franchise Enquire List</h5>
                        <!--end::Page Title-->
                    </div>
                    <!--end::Page Heading-->
                </div>
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{url('franchises-enquires/create')}}" class="btn btn-primary font-weight-bold btn-sm">Add New</a>
                    <!--end::Actions-->
                </div>
                <!--end::Toolbar-->
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-warning" data-toggle="tooltip"
                                           ...
                                           href="{{ url('franchises-enquires/'.$item->franchise_enquire_id. '/edit')}}">
                                            <i class="flaticon2-pen"></i>
                                        </a>
                                        <form method="POST" style="display:inline;" title="Delete" id="delete-post-form"
                                              action="{{ url('franchises-enquires',$item->franchise_enquire_id)  }}">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
