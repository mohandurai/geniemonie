...
@section('content')
        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('permissions.index')}}" class="btn  font-weight-bolder btn-sm">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" opapermissions="0.3"/>
    </g>
                ...
                <div class="col-lg-8">
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <form class="form" id="kt_form"
                              action="{{ isset($permissions)?route('permissions.update',$permissions->id):route('permissions.store') }}"
                              method="POST">
                            @csrf
                            @isset($permissions)
                                @method('PUT')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                            <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                                   ...
                                                   value="{{ old('name')?old('name'):(isset($permissions)?$permissions->name:'')}}"/>
                                            @if ($errors->has('name'))
