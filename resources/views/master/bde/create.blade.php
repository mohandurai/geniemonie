        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('bde.index')}}" class="btn  font-weight-bolder btn-sm">
                ...
                <div class="col-lg-12">
                    <div class="card card-custom gutter-b example example-compact">
                        <form class="form" id="kt_form"
                              action="{{ isset($bDE)?route('bde.update',$bDE->id):route('bde.store') }}"
                              method="POST">
                            @csrf
                            @isset($bDE)
                                @method('PUT')
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('name')?old('name'):(isset($bDE)?$bDE->name:'')}}"/>
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" class="form-control" readonly id="kt_datepicker_3"
                                                   name="date_of_join"
                                                   value="{{ !empty(old('date_of_join'))?old('date_of_join'):(!empty($bDE->date_of_join)?date('d-m-Y',strtotime($bDE->date_of_join)):date('d-m-Y')) }}"/>
								...
								<i class="la la-calendar"></i>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('education')?old('education'):(isset($bDE)?$bDE->education:'')}}"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('experience')?old('experience'):(isset($bDE)?$bDE->experience:'')}}"/>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select
                                            ...
                                            <option
                                                value="Married"{{ !empty($bDE->marital_status) && $bDE->marital_status== 'Married' ? 'selected':''}} {{ ((old('marital_status')== 'Married')?'selected': '') }}>
                                                Married
                                            </option>
                                            <option
                                                value="Unmarried"{{ !empty($bDE->marital_status) && $bDE->marital_status== 'Unmarried' ? 'selected':''}} {{ ((old('marital_status')== 'Unmarried')?'selected': '') }}>
                                                Unmarried
                                            </option>
                                        </select>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select
                                            ...
                                            <option
                                                value="M"{{ !empty($bDE->gender) && $bDE->gender== 'M' ? 'selected':''}} {{ ((old('gender')== 'M')?'selected': '') }}>
                                                Male
                                            </option>
                                            <option
                                                value="F"{{ !empty($bDE->gender) && $bDE->gender== 'F' ? 'selected':''}} {{ ((old('gender')== 'F')?'selected': '') }}>
                                                Female
                                            </option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('father_name')?old('father_name'):(isset($bDE)?$bDE->father_name:'')}}"/>
                                    ...
                                    @if(empty($bDE))
                                        <div class="col-lg-4">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('email')?old('email'):(isset($bDE)?$bDE->email:'')}}"/>
                                            @if ($errors->has('email'))
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input
                                                ...
                                                autocomplete="off"
                                                placeholder="******"
                                                value="{{ old('password')?old('password'):(isset($bDE)?$bDE->password:'')}}"/>
                                        ...
                                        <select
                                            ...
                                            @if(!empty($bDE))
                                                @foreach($state as $value)
                                                    <option
                                                        value="{{$value->state_id}}"{{ !empty($bDE->state_id) && $bDE->state_id==$value->state_id ? 'selected':''}} {{ ((old('state_id')==$value->state_id)?'selected': '') }}>{{$value->state_name}}</option>
                                                @endforeach
                                            @endif
                                        ...
                                        <select
                                            ...
                                            @if(!empty($bDE))
                                                @foreach($district as $value)
                                                    <option
                                                        value="{{$value->district_id}}"{{ !empty($bDE->district_id) && $bDE->district_id==$value->district_id ? 'selected':''}} {{ ((old('district_id')==$value->district_id)?'selected': '') }}>{{$value->district_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        ...
                                        <select
                                            ...
                                            @if(!empty($bDE))
                                                @foreach($city as $value)
                                                    <option
                                                        value="{{$value->city_id}}"{{ !empty($bDE->city_id) && $bDE->city_id==$value->city_id ? 'selected':''}} {{ ((old('city_id')==$value->city_id)?'selected': '') }}>{{$value->city_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input
                                            ...
                                            value="{{ old('address')?old('address'):(isset($bDE)?$bDE->address:'')}}"/>
