        ...
        <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
            <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Actions-->
                    <a href="{{route('roles.index')}}" class="btn  font-weight-bolder btn-sm">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <form class="form" id="kt_form"
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                               ...
                                               value="{{ old('name')?old('name'):(isset($roles)?$roles->name:'')}}"/>
                                        @if ($errors->has('name'))
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label ">Permission<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                                        ...
                                                        <div class="checkbox-inline">
                                                            <label class="checkbox checkbox-lg">
                                                                <input type="checkbox" class="permission " name="permission[{{ $permission->name }}]"  value="{{ $permission->name }}"
                                                                    {{ !empty($rolePermissions) && in_array($permission->name, $rolePermissions)? 'checked': '' }}>
                                                                <span></span>
                                                            </label>
                                                        </div>
                                                    </td>
